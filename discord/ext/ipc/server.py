...
class Server:
    ...
    async def start(self):
        ...
        if self.do_multicast:
            ...
            await self.loop.run_until_complete(self.__start(self._multicast_server, self.multicast_port))

        await self.loop.run_until_complete(self.__start(self._server, self.port))
